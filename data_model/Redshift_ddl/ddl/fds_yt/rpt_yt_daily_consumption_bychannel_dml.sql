...
insert into fds_yt.rpt_yt_daily_consumption_bychannel
...
from fds_yt.agg_yt_monetization_summary a 
left join 
        (
        ...
        from cdm.dim_region_country b
        inner join cdm.dim_country c
