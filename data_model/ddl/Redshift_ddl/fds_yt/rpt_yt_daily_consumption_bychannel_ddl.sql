...
CREATE TABLE
    ...
    (
       date DATE ENCODE LZO,
        ...
        channel_name CHARACTER VARYING(500) ENCODE LZO,
        country_code CHARACTER VARYING(100) ENCODE LZO,
       content_type CHARACTER VARYING(100) ENCODE LZO,
		country_name CHARACTER VARYING(1000) ENCODE LZO,
		region_name CHARACTER VARYING(500) ENCODE LZO,
