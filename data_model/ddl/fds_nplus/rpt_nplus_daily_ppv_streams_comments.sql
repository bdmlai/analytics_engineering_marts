...
COMMENT ON COLUMN fds_nplus.rpt_nplus_daily_ppv_streams.streams IS 'Count of stream ids';
COMMENT ON COLUMN fds_nplus.rpt_nplus_daily_ppv_streams.cum_unique_users IS 'count of cumulative users';
