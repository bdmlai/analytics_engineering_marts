...
COMMENT ON COLUMN fds_nplus.rpt_nplus_daily_nxt_tko_streams.intvl_dttm IS 'Time splitted into 5 minutes interval between airdate and current date';	
...
COMMENT ON COLUMN fds_nplus.rpt_nplus_daily_live_streams.streams IS 'Count of stream ids';
COMMENT ON COLUMN fds_nplus.rpt_nplus_daily_live_streams.cum_unique_users IS 'count of cumulative users';
