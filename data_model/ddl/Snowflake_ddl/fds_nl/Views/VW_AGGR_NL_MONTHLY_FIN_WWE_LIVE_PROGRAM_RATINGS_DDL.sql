...
CREATE VIEW
    vw_aggr_nl_monthly_fin_wwe_live_program_ratings COMMENT=  'A view to display various dimensions and metrics of wwe live programs on financial month-basis'
    (
        broadcast_fin_month COMMENT 'Broadcast Financial Month',
