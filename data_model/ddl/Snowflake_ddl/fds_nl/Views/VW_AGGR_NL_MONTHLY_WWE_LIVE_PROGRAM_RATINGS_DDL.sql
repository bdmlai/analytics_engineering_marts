CREATE VIEW
    vw_aggr_nl_monthly_wwe_live_program_ratings COMMENT = 'A view to display various dimensions and metrics of wwe live program ratings on monthly-basis'
    (
        broadcast_month COMMENT 'Broadcast Calendar Month',
...
sum(viewing_minutes_units) as tot_viewing_minutes, count(*) as number_of_airings
