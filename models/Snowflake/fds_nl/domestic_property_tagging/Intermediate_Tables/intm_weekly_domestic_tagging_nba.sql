...
{{property_tagging("property",'src_series_name',nba_not_series_flag,"","","not","","")}},
{{property_tagging("property","","",'src_genre_classification_detailedtypecd',nba_not_genre_detailed_cd_flag,
"","","not")}},
'NBA' as property
from {{ref('base_weekly_domestic_tagging')}} where property__or__flag =1 and property_not___flag=1
and property___not_flag=1
)
