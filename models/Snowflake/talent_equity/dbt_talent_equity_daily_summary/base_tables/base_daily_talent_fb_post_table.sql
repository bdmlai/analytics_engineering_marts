/*
*************************************************************************************************************************************************
   TableName   : base_daily_talent_fb_post_table
   Schema	   : CREATIVE
   Contributor : Sourish Chakraborty
   Description : Base Model to capture #Fb posts and engagements for talents
...
count(distinct dim_media_id)as tot_fb_post,sum(engagements) as tot_eng_fb_post
