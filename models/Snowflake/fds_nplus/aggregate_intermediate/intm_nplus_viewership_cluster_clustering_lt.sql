/***********************************************************************************/
/*                  7.  tier 3 model - rules based behaviors-final(lt)             */
/* db:analytics_workspace schema:content                                           */
/* input tables: intm_nplus_viewership_cluster_clustering_sub_rules_lt             */
/*               intm_nplus_viewership_cluster_user_act_month                      */
/* ouput tables: intm_nplus_viewership_cluster_clustering_lt                       */
/***********************************************************************************/
{{
    config(
        materialized='table',
...
base as (
    ...
    select * from {{ ref('intm_nplus_viewership_cluster_clustering_sub_rules_lt') }}
