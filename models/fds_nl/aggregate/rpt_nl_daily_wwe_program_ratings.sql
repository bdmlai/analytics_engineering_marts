...
a.src_broadcast_network_id, f.broadcast_network_name, a.src_playback_period_cd, a.src_demographic_group, a.src_program_id,a.src_series_name, 
a.src_program_attributes,a.program_aired_weekday,a.telecast_trackage_name,
a.src_episode_id,a.src_episode_number,a.src_episode_title,a.src_daypart_cd,
...
a.avg_audience_pct, a.avg_audience_pct_nw_cvg_area, 
a.avg_viewing_hours_units/60 as viewing_hours ,a.avg_viewing_hours_persons/60 as viewing_hours_000,
 a.avg_audience_proj_units, a.share_pct, a.share_pct_nw_cvg_area,
...
select broadcast_date_id, broadcast_date, orig_broadcast_date_id,dim_nl_broadcast_network_id, src_broadcast_network_id, src_playback_period_cd, 
src_demographic_group, src_program_id,src_series_name, 
src_program_attributes,program_aired_weekday,telecast_trackage_name,src_episode_id,src_episode_number,src_episode_title,
dim_nl_daypart_id, src_daypart_cd,
...
(sum(avg_audience_pct_nw_cvg_area * src_total_duration)/nullif(sum(nvl2(avg_audience_pct_nw_cvg_area, src_total_duration, null)), 0)) as avg_audience_pct_nw_cvg_area,
 ...
 sum(avg_viewing_hours_persons) as avg_viewing_hours_persons,
...
join (select dim_nl_episode_id,dim_source_sys_id,src_episode_title from fds_nl.dim_nl_episode )n
on b.dim_nl_episode_id=n.dim_nl_episode_id
and b.dim_source_sys_id=n.dim_source_sys_id
...
select broadcast_date_id, broadcast_date, orig_broadcast_date_id,dim_nl_broadcast_network_id, src_broadcast_network_id, src_playback_period_cd, 
src_demographic_group, src_program_id ,src_series_name, 
src_program_attributes,program_aired_weekday,telecast_trackage_name,src_episode_id,
src_episode_number,src_episode_title,
dim_nl_daypart_id, src_daypart_cd, program_telecast_rpt_starttime, program_telecast_rpt_endtime,
