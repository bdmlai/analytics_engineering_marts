{{
  config({
	"materialized": 'view',
	"post-hook": ["COMMENT ON COLUMN fds_nl.vw_aggr_nl_quarterly_wwe_live_quarterhour_ratings.broadcast_month IS 'Show broadcast month'"]
	})
}}
...
*************************************************************************************************************************************************
   ...
   Description : WWE Live Quarter Hour Rating Quarterly Aggregate View consist of rating details of all WWE Live - RAW, SD, NXT Programs to be rolled up from Quarter Hour Viewership Ratings Table on quarterly-basis
*************************************************************************************************************************************************
*/

create view vw_aggr_nl_quarterly_wwe_live_quarterhour_ratings
as
select substring(b.cal_year_qtr_desc, 5, 2) as broadcast_quarter, b.cal_year as broadcast_year, src_broadcast_network_id, src_playback_period_cd, src_demographic_group, src_program_id, interval_starttime, interval_endtime,
