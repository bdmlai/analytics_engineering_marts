...
sum(b.orders_wk) as orders_ytd,
sum(b.revenue_wk) as revenue_ytd,
avg(b.avg_order_size_wk) as avg_order_size_ytd,
sum(b.prev_orders_wk) as prev_orders_ytd,
sum(b.prev_revenue_wk) as prev_revenue_ytd,
avg(b.prev_avg_order_size_wk) as prev_avg_order_size_ytd
