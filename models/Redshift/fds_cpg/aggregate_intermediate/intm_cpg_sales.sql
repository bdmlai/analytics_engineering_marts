...
cast(src_order_type as varchar(1)) as src_order_type,date_key,dim_item_id,other_amount,src_unit_cost,src_current_retail_price,
...
) where (src_currency_code_from!='CAD' or date_key !='19000101')