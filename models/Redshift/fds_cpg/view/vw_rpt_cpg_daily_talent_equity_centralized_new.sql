...
from(
select date, lineage_name,brand, tot_views, tot_yt_vids, tot_eng_fb_post, tot_eng_fb_vids, tot_eng_tw_post, tot_eng_tw_vids
from {{source('fds_cpg', 'rpt_daily_talent_equity_centralized')}}
group by 1,2,3,4,5,6,7,8,9)group by 1,2,3
