...
0 as Clicks
from {{source('hive_udl_mkt','wavemaker_monthly_display_mmm')}}
...
from {{source('hive_udl_mkt','wavemaker_monthly_search_mmm')}}
group by 1,2,3,4,5,6),
...
sum(cost) as Spend,
0 as Clicks
from {{source('hive_udl_mkt','wavemaker_monthly_youtube_mmm')}}
group by 1,2,3,4,5,6),
...
0 as Clicks
from {{source('hive_udl_mkt','wavemaker_monthly_facebook_mmm')}}
group by 1,2,3,4,5,6),
...
sum(spend) as Spend,
0 as Clicks
from {{source('hive_udl_mkt','wavemaker_monthly_twitter_mmm')}}
group by 1,2,3,4,5,6),
...
sum(spend) as Spend,
0 as Clicks
from {{source('hive_udl_mkt','wavemaker_monthly_snapchat_mmm')}}
group by 1,2,3,4,5,6),
