{{
  config({
		"schema": 'fds_yt',
		"pre-hook": ["truncate fds_yt.rpt_yt_daily_wwe_talent_views_pastquarter"],
		"materialized": 'incremental','tags': "Content", "persist_docs": {'relation' : true, 'columns' : true},
	        'post-hook': 'grant select on fds_yt.rpt_yt_daily_wwe_talent_views_pastquarter to public'
...
from {{ref('intm_yt_daily_wwe_talent_pastquarter')}} a
