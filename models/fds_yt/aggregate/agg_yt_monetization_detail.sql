{{
  config({
    ...
    "pre-hook": "delete from dt_prod_support.agg_yt_monetization_detail where report_date between cast(to_char(current_date-52,'YYYYMMDD') as int) and cast(to_char(current_date,'YYYYMMDD') as int)",
