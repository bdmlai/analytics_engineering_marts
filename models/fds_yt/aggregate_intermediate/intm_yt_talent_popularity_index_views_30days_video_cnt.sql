...
from {{ref('intm_yt_talent_normal_views_30days_video_cnt')}} group by 1,2) as a
inner join 
{{ref('intm_yt_talent_normal_views_30days_video_cnt')}} b on a.region_code=b.region_code and a.granularity=b.granularity
