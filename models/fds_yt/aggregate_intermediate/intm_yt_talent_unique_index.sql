...
from {{ref('intm_yt_talent_views_unique_average')}} group by 1,2) as a
inner join 
(select region_code, talent, granularity
,cast(normal_views as float) total_views

from {{ref('intm_yt_talent_views_unique_average')}}) b on a.talent=b.talent and a.granularity=b.granularity
