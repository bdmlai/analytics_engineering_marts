{{
  config({
		'schema': 'fds_cpg',
		"pre-hook": ["truncate fds_cpg.rpt_cpg_daily_snapshot_shipped_sale"],
        ...
        from 
                (select distinct a.*, b.src_style_id, b.src_style_description, b.src_category_description,
                 ...
                 from 
                        ...
                        left join {{source('fds_cpg','fact_cpg_inventory')}} b on a.dim_item_id = b.dim_item_id and a.ship_date_id = b.dim_date_id 
