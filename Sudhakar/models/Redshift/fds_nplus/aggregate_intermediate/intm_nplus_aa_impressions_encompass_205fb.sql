{{
  config({
		"materialized": 'ephemeral'
			...
			(12.5 * interval '1 hour') END as varchar) as start_time_join,
            ...
            ELSE to_timestamp(CAST(airdate as varchar) || ' ' || substring(outpoint, 1, 8), 'YYYY-MM-DD HH24:MI:SS')::TIMESTAMP + (12.5 * interval '1 hour') END as varchar) as end_time,
            ...
            WHERE (airdate>='2018-01-16' AND airdate < '2018-04-03')
