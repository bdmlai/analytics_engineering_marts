{{
  config({
		"materialized": 'ephemeral'
            ...
            ELSE to_timestamp(CAST(airdate as varchar) || ' ' || substring(inpoint, 1, 8), 'YYYY-MM-DD HH24:MI:SS')::TIMESTAMP + (12 * interval '1 hour') END as varchar) as start_time_join,
            ...
            ELSE to_timestamp(CAST(airdate as varchar) || ' ' || substring(outpoint, 1, 8), 'YYYY-MM-DD HH24:MI:SS')::TIMESTAMP + (12 * interval '1 hour') END as varchar) as end_time,
            ...
            WHERE (airdate>='2017-01-01' OR title= 'Live Event (Saudi Arabia Royal Rumble)')
