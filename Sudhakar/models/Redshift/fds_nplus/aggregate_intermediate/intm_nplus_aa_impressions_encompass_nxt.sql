{{
  config({
		"materialized": 'ephemeral'
            ...
            SELECT CAST(CASE WHEN title= 'Live Event (Saudi Arabia Royal Rumble)' THEN
			to_timestamp(CAST('2018-04-27' as varchar) || ' ' || 
            ...
            ELSE to_timestamp(CAST(airdate as varchar) || ' ' || substring(outpoint, 1, 8), 'YYYY-MM-DD HH24:MI:SS')::TIMESTAMP + 
			(19 * interval '1 hour') END as varchar) as end_time,
            ...
            AND lower(title)!='raw' AND lower(title)!='smackdown'
            AND lower(title)='nxt'