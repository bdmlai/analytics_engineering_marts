/***********************************************************************************/
/*           5.  tier 3 model - user consumption(ST)                               */
...
/*               intm_nplus_viewership_cluster_content_duration_st                 */
/* ouput tables: intm_nplus_viewership_cluster_user_consumption_st                 */
/***********************************************************************************/
{{
    config(
        materialized='table',
...
content_duration as (
    ...
    select * from {{ ref('intm_nplus_viewership_cluster_content_duration_st') }}
...
user_consumption_4 as (
    ...
    select 
        ...
        t1.*,
        t2.st_act_mo_clean as act_months,
