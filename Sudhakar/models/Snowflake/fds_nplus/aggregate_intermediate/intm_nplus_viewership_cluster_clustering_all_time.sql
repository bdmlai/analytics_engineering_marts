/***********************************************************************************/
/*                 7.  tier 3 model - rules based behaviors-final(all_time)        */
/* db:analytics_workspace schema:content                                           */
/* input tables: intm_nplus_viewership_cluster_clustering_sub_rules_all_time       */
/*               intm_nplus_viewership_cluster_user_act_month                      */
/* ouput tables: intm_nplus_viewership_cluster_clustering_all_time                 */
/***********************************************************************************/
{{
    config(
        materialized='table',
...
base as (
    ...
    select * from {{ ref('intm_nplus_viewership_cluster_clustering_sub_rules_all_time') }}
