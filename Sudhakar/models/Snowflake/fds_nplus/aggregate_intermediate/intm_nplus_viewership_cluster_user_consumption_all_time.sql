/***********************************************************************************/
/*           5.  tier 3 model - user consumption(all_time)                         */
...
/*               intm_nplus_viewership_cluster_content_duration_all_time           */
/* ouput tables: intm_nplus_viewership_cluster_user_consumption_all_time           */
/***********************************************************************************/
{{
    config(
        materialized='table',
...
base as (
    ...
    where (short_term_flag = 1  or mid_term_flag = 1 or long_term_flag = 1)    
...
content_duration as (
    ...
    select * from {{ ref('intm_nplus_viewership_cluster_content_duration_all_time') }}
...
user_consumption_4 as (
    ...
    select 
        ...
        t1.*,
        t2.all_time_act_mo_clean as act_months,
