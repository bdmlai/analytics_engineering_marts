/***********************************************************************************/
/*           5.  tier 3 model - user consumption(LY)                               */
...
/*               intm_nplus_viewership_cluster_content_duration_ly                 */
/* ouput tables: intm_nplus_viewership_cluster_user_consumption_ly                 */
/***********************************************************************************/
{{
    config(
        materialized='table',
...
base as (
    ...
    where (short_term_flag = 1  or mid_term_flag = 1 )   
...
content_duration as (
    ...
    select * from {{ ref('intm_nplus_viewership_cluster_content_duration_ly') }}
