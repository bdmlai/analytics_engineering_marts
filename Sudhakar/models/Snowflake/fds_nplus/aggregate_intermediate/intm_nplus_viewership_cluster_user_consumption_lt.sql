/***********************************************************************************/
/*           5.  tier 3 model - user consumption(LT)                               */
...
/*               intm_nplus_viewership_cluster_content_duration_lt                 */
/* ouput tables: intm_nplus_viewership_cluster_user_consumption_lt                 */
/***********************************************************************************/
{{
    config(
        materialized='table',
        tags=['viewership','viewership_model','lt'],
		schema='fds_nplus'
    )
}}
...
content_duration as (
    ...
    select * from {{ ref('intm_nplus_viewership_cluster_content_duration_lt') }}
...
user_consumption_4 as (
    ...
    select 
        ...
        t1.*,
        t2.lt_act_mo_clean as act_months,
