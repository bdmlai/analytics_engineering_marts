/***********************************************************************************/
/*                6. tier 3 model - rules based behaviors-sub-rules(all_time)      */
/* db:analytics_workspace schema:content                                           */
/* input tables: intm_nplus_viewership_cluster_user_consumption_all_time           */
/* ouput tables: intm_nplus_viewership_cluster_clustering_sub_rules_all_time       */
/***********************************************************************************/
...
base as (
    ...
    select * from {{ ref('intm_nplus_viewership_cluster_user_consumption_all_time') }}
