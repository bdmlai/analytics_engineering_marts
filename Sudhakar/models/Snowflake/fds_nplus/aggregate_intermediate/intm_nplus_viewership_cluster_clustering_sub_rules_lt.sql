/***********************************************************************************/
/*                6. tier 3 model - rules based behaviors-sub-rules(lt)            */
/* db:analytics_workspace schema:content                                           */
/* input tables: intm_nplus_viewership_cluster_user_consumption_lt                 */
/* ouput tables: intm_nplus_viewership_cluster_clustering_sub_rules_lt             */
/***********************************************************************************/
...
base as (
    ...
    select * from {{ ref('intm_nplus_viewership_cluster_user_consumption_lt') }}
