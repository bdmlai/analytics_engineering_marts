  ...
  create view "entdwdb"."fds_nl"."vw_aggr_nl_yearly_wwe_live_program_ratings__dbt_tmp" as (
    /*
*************************************************************************************************************************************************
   Date        : 07/21/2020
   Version     : 1.0
...
SELECT broadcast_cal_year as broadcast_year, src_broadcast_network_id, src_playback_period_cd, src_demographic_group, src_program_id,
