  ...
  create view "entdwdb"."fds_nl"."vw_aggr_nl_monthly_fin_wwe_live_program_ratings__dbt_tmp" as (
    /*
*************************************************************************************************************************************************
   Date        : 07/21/2020
   Version     : 1.0
...
select broadcast_fin_month_nm as broadcast_fin_month, broadcast_fin_year, src_broadcast_network_id, src_playback_period_cd, src_demographic_group, src_program_id,
