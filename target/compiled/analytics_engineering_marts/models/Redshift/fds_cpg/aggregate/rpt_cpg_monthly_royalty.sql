...
(
	...
	from "entdwdb"."udl_pii"."restricted_cpg_clientbase_monthly_shipment"
	group by 1,2,3,4
),
...
(
	...
	from "entdwdb"."hive_udl_cpg"."clientbase_monthly_returns"
	group by 1,2,3,4
),
...
(
	...
	from "entdwdb"."hive_udl_cpg"."radial_monthly_order_ship"
	group by 1,2,3,4
...
(
	...
	select distinct 
			...
			, abs(COALESCE(SUM(merch_net),0.000)) AS returned_sales
	from "entdwdb"."hive_udl_cpg"."radial_monthly_order_return"
	group by 1,2,3,4
),
...
(
	...
	from "entdwdb"."hive_udl_cpg"."radial_monthly_payment_refund"
...
(
	...
	from "entdwdb"."hive_udl_cpg"."raw_amazon_monthly_payments"
...
(
        ...
        from "entdwdb"."fds_cpg"."dim_cpg_item" where active_flag='Y'
) where row_num=1
)
...
inner join "entdwdb"."cdm"."dim_date" c on a.report_month=c.full_date