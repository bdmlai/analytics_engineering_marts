...
from "entdwdb"."fds_kntr"."vw_aggr_kntr_schedule_wca_data"
...
left join
(select distinct country_nm, region_nm as region from "entdwdb"."cdm"."dim_region_country" where ent_map_nm = 'GM Region') f
