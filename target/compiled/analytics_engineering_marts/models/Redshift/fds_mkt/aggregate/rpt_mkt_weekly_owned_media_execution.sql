...
from "entdwdb"."fds_yt"."youtube_cards"
...
when src_program_name like '%SMACKDOWN%' then 'SMACKDOWN'
...
-- Included 'WWE SMACKDOWN' program name to the filter to get US Viewership Data for SmackDown before 10/06/2019 , jira : NS-850
and src_program_name in ('WWE ENTERTAINMENT','WWE FRI NIGHT SMACKDOWN','WWE FRI NIGHT SMACKDOWN L','WWE SMACKDOWN','WWE NXT')
group by 1,2,3,4,5,6),
...
from "entdwdb"."fds_nplus"."rpt_network_ppv_liveplusvod"
