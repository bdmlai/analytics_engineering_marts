...
a.src_broadcast_network_id, f.broadcast_network_name, a.src_playback_period_cd, a.src_demographic_group, a.src_program_id, 
a.src_series_name, a.src_program_attributes, a.program_aired_weekday, a.src_episode_id, a.src_episode_number, j.src_episode_title, 
a.src_daypart_cd, g.src_daypart_name, a.program_telecast_rpt_starttime, a.program_telecast_rpt_endtime, a.src_total_duration, 
a.avg_audience_proj_000, a.avg_audience_pct, a.avg_audience_pct_nw_cvg_area, 
...
src_broadcast_network_id, src_playback_period_cd, src_demographic_group, src_program_id, src_series_name, dim_source_sys_id,
src_program_attributes, program_aired_weekday, dim_nl_episode_id, src_episode_id, src_episode_number, dim_nl_daypart_id, src_daypart_cd,
...
select broadcast_date_id, broadcast_date, orig_broadcast_date_id, dim_nl_broadcast_network_id, 
src_broadcast_network_id, src_playback_period_cd, src_demographic_group, src_program_id, src_series_name, dim_source_sys_id,
src_program_attributes, program_aired_weekday, dim_nl_episode_id, src_episode_id, src_episode_number, dim_nl_daypart_id, src_daypart_cd, program_telecast_rpt_starttime, program_telecast_rpt_endtime,
...
left join "entdwdb"."fds_nl"."dim_nl_episode" j on a.dim_nl_episode_id = j.dim_nl_episode_id and a.dim_source_sys_id = j.dim_source_sys_id