...
with __dbt__CTE__intm_yt_daily_wwe_video_halfyear as (
...
where date(time_uploaded) > date(getdate()-180)  
...
),  __dbt__CTE__intm_yt_daily_wwe_talent_halfyear as (
...
from __dbt__CTE__intm_yt_daily_wwe_talent_halfyear a
