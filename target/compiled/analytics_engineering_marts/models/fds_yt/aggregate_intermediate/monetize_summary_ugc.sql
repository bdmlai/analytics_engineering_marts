...
with __dbt__CTE__ugc_engage_measures as (
...
from "entdwdb"."fds_yt"."rpt_yt_revenue_daily" where report_date between to_char(current_date - 52, 'YYYYMMDD')   and to_char(current_date - 1, 'YYYYMMDD') 
...
from "entdwdb"."fds_yt"."rpt_yt_demographics_views_daily" where report_date_dt between current_date-52 and current_date - 1 and uploader_type in ( 'self' , 'thirdParty')) d 
